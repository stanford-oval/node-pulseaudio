...
class Context extends Events.EventEmitter {
    constructor(opts) {
        ...
        const ctx = this.$ = new PulseContext(opts.client, (state, error) => {
...
function createStream(ctx, self, opts, type){
    ...
    const stm = self.$ = new PulseStream(ctx.$, str2num(opts.format, PulseStream.format), opts.rate, opts.channels, opts.latency, opts.stream, (state, error) => {
